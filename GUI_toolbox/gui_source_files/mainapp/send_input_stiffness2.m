function send_input_stiffness2
%% aurora system initialization
global aurora_device PositionArray ControlPeriod PositionLastStep pressure time pwmtemp1 pwmtemp2 pwmtemp3 pwm_counter step s
...
%Aurora_position = s.UserData.Position;
